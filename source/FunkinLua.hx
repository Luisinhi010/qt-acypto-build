...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('qtOldVocals', ClientPrefs.qtOldVocals);
		set('qtSkipCutscene', ClientPrefs.qtSkipCutscene);
		set('qtSawbladeBonk', ClientPrefs.qtBonk);
		...
		Lua_helper.add_callback(lua, "flipCamShitTest", function(camera:String) {
			PlayState.instance.flippyTime(camera);
		});
